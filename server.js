...
mongoose.connect("mongodb+srv://Kaz:Web322!!@senecacluster.qmmqa.mongodb.net/SenecaCluster?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
...
app.post("/logged", (req, res) => {
    ...
    // findUser2 = function (userData) {
    //     return User.find({
    //         email: userData.email
    //     }).exec().then((data) => {
    //         console.log("data from function2: " + data);
    //         return data
    //     })
    // }
